    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-7xl mx-auto px-2 sm:px-0">
            ...
            >
                ...
                <div className="absolute bottom-10 left-10 w-32 h-32 bg-teal-100 rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-500 blur-3xl"></div>
