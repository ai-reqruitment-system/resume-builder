...
const ExperienceEnhanced = ({ formData, updateFormData, step = 1 }) => {
    ...
    // Step 1: Basic experience information form
    if (step === 1) {
        return (
            <div className="w-full space-y-5">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 xxs:gap-2 mb-2 xxs:mb-3">
                    <div>
                        <h2 className="text-lg xxs:text-xl font-semibold text-gray-800 mb-0.5 xxs:mb-1">Work Experience</h2>
                        <p className="text-gray-500 text-xs xxs:text-sm">Add your professional work history</p>
                    </div>
                    <button
                        onClick={addExperience}
                        className="w-full sm:w-auto px-2 xxs:px-3 sm:px-4 py-1 xxs:py-1.5 sm:py-2 bg-teal-50 text-teal-600 rounded-lg
    ...
    return (
        <div className="w-full space-y-5">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-3">
                <div>
                    <h2 className="text-xl font-semibold text-gray-800 mb-1">Work Experience Details</h2>
                    <p className="text-gray-500 text-sm">Add descriptions for your professional experiences</p>
                </div>
            </div>
            ...
            <div className="space-y-3">
                {formData.job_title.map((_, index) => (
                    <div key={index} className="border border-gray-100 rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-md transition-all duration-300">
                        <div
                            onClick={() => setActiveIndex(activeIndex === index ? -1 : index)}
                            className="w-full flex items-center justify-between p-3 sm:p-4 bg-gray-50
                                hover:bg-gray-100 transition-all duration-300 cursor-pointer
                                border-b border-gray-100"
                        >
