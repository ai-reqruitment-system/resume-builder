                    ...
                    <form onSubmit={handleCompleteProfile} className="space-y-8">
                        <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
                            <h2 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                                <UserCircle2 className="w-5 h-5 mr-2 text-teal-500" />
                            ...
                            <div>
                                    ...
                                    <div key={index} className="flex items-center gap-2 mb-2">
                                        <div className="relative flex-1 rounded-md shadow-sm">
                                            ...
                                            <input
                                                ...
                                                className={`pl-10 block w-full rounded-md ${fieldErrors.job_roles || fieldErrors['job_roles.0'] || fieldErrors[`job_roles.${index}`] ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-teal-500 focus:ring-teal-500'} shadow-sm sm:text-sm`}
                                ...
                                {formData.job_roles.length < 5 && (
                                    <button
                                        ...
                                        className="mt-2 text-sm text-teal-500 hover:text-teal-700"
                                    >
                                        + Add another role
                                    </button>
                                )}
                                    ...
                                    <div key={index} className="flex items-center gap-2 mb-2">
                                        <div className="relative flex-1 rounded-md shadow-sm">
                                            ...
                                            <input
                                                ...
                                                className={`pl-10 block w-full rounded-md ${fieldErrors.selected_locations || fieldErrors['selected_locations.0'] || fieldErrors[`selected_locations.${index}`] ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-teal-500 focus:ring-teal-500'} shadow-sm sm:text-sm`}
